...
public class CameraFadeScript : MonoBehaviour
{
    ...
    {
        StartFade(Color.black, new Color(0, 0, 0, 0), 1.0f);
    ...
    {
        StartFade(new Color(0, 0, 0, 0), Color.black, 1.0f);
    }
    ...
    {
        CameraFadeScript cfs = GameObject.Find("CameraFade").GetComponent<CameraFadeScript>();
        return cfs;
    }
